        ...
        <div id="board">
            ...
            <div class="sect">
                ...
                <div class="first">
                    ...
                    <p class="fs11 fcgray9 pdB7 tar blind480"><i class="fa fa-file-o"></i> 총 <strong
                            class="fcgray5">${totalCnt}</strong>개의 글이 등록되어 있습니다.</p>
                    <table border="0" cellspacing="0" cellpadding="0" class="tb_bd_list">
                        ...
                        <g:each in="${list}" var="item" status="i">
                            <tr>
                                <td class="blind768">${item.seq}</td>
                                <td class="subject">
                                    <a href="/support/noticeShow?id=${item.seq}">${item.title}</a>
                                </td>
                                <td class="name">${item.author}</td>
                                <td class="blind768">${item.postDate.format('yyyy-MM-dd')}</td>
                                <td class="blind768">${item.viewCount}</td>
                            </tr>
                        </g:each>
                    <!--
